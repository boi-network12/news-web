...
import { FaUserCircle, FaEnvelope, FaGlobe, FaMapMarkerAlt, FaKey, FaCode } from 'react-icons/fa';
import './Profile.css';
...
const Profile = () => {
  ...
  const handleGetAPI = () => {
    navigate('/developer-api'); // Navigate to API page (Change the route if needed)
  };
  ...
  return (
    <div className="profile-container">
      ...
      <button className="developer-button" onClick={handleGetAPI}>
        <FaCode className="button-icon" /> Get API
      </button>
